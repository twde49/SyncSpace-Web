<template>
    <MdEditor ref="mdEditorRef" :toolbarsExclude="excluded" :placeholder="placeholder" language="fr-FR"
        :theme="$colorMode.preference === 'light' ? 'dark' : 'light'" class="markdownEditor" v-model="content"
        :preview="false" :footers="footer" @onSave="handleSave" contentClass="cm-content" />
