<template>
    <div :class="isActive
        ...
        <div class="conversation-header">
            <div class="w-max bgColorWhite topComponentSize flex justify-center items-center">
                <span class="profile-name">{{ getLastActiveUserInitial() }}</span>
            </div>
            <span
                :class="['activityPill', isAllUserConnected(conversation) ? 'bgColorCategoryTritary' : 'bgColorCategoryQuaternary']" />
        </div>
