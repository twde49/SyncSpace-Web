      ...
      <div class="about-content">
        ...
        <div class="hero-section mb-16">
          ...
          <p class="largeFont textColorWhite mb-6 opacity-90">
            La solution modulaire qui révolutionne votre environnement de travail numérique
          </p>
        </div>
        ...
        <section class="mission-section mb-16">
          ...
          <div class="mission-content">
            <div class="mission-text">
              <p class="normalFont textColorWhite mb-4">
                L'environnement de travail moderne est saturé par une prolifération d'applications spécialisées. 
                Cette fragmentation crée un écosystème numérique complexe qui génère des pertes de productivité, 
                des risques de sécurité accrus et une collaboration dégradée.
              </p>
              <p class="normalFont textColorWhite mb-6">
                <span class="textColorTritary font-semibold">SyncSpace</span> répond à cette problématique en proposant 
                une plateforme modulaire unique qui centralise vos outils essentiels tout en garantissant 
                sécurité et simplicité d'utilisation.
              </p>
              <div class="mission-goals">
                <div class="goal-item">
                  <Icon name="ri:target-line" class="textColorTritary" />
                  <span class="textColorWhite">Réduire le temps de basculement entre applications de 25%</span>
                </div>
                <div class="goal-item">
            ...
            <div class="mission-visual">
              <div class="feature-preview">
                <Icon name="ri:apps-line" size="300%" class="textColorTritary" />
        ...
        <section class="modules-section mb-16">
          <div class="section-header mb-8">
            ...
            <p class="normalFont textColorWhite opacity-80">
              Découvrez les fonctionnalités qui font de SyncSpace votre allié productivité
            </p>
          </div>
          ...
          <div class="roadmap-timeline">
            ...
            >
              <div class="timeline-marker">
                <Icon 
                  :name="milestone.completed ? 'ri:check-line' : 'ri:time-line'" 
        ...
        <section class="team-section mb-16">
          ...
          <div class="engagement-grid">
            <div class="engagement-item">
              <Icon name="ri:heart-line" size="150%" class="textColorTritary mb-4" />
            ...
            <div class="engagement-item">
              <Icon name="ri:shield-star-line" size="150%" class="textColorTritary mb-4" />
              <h3 class="mediumFont textColorWhite mb-2">Sécurité d'abord</h3>
              <p class="smallFont textColorWhite opacity-80">
                Vos données sont protégées par les plus hauts standards de sécurité et stockées en France
              </p>
            </div>
            <div class="engagement-item">
              <Icon name="ri:rocket-line" size="150%" class="textColorTritary mb-4" />
...
const roadmap = ref([
  {
    month: "Juillet 2025",
    description: "Deuxième beta, stabilisation modules",
    completed: true
  },
  {
    month: "Août 2025",
    description: "Correction retour beta et finitions",
    completed: true
  },
  {
    month: "Septembre 2025",
    description: "Déploiement initial du module de gestion de tâches",
    completed: false
  },
  {
    month: "Octobre 2025",
    description: "Intégration avancée du calendrier avec les outils tiers",
    completed: false
  },
  {
    month: "Novembre 2025",
    description: "Amélioration des performances du Drive et ajout du versioning",
    completed: false
  },
  {
    month: "Décembre 2025",
    description: "Lancement du module de notes collaboratives et de wiki interne",
    completed: false
  },
]);
</script>
...
.roadmap-timeline {
  ...
  gap: 30px;
  position: relative;
  max-width: 600px; /* Added to constrain and center the timeline block */
  margin: 0 auto; /* Added to center the roadmap block */
  padding-left: 0; /* Removed original padding-left */
}

.roadmap-timeline::before {
  content: '';
  position: absolute;
  left: 20px; /* Stays relative to the centered roadmap-timeline block's left */
  top: 0;
  bottom: 0;
  width: 2px;
  background: linear-gradient(180deg, #ff7f50, #ff5722);
}
...
.timeline-item {
  ...
  gap: 20px;
  margin-left: 40px; /* Added to push content right, effectively replacing original roadmap-timeline padding */
}

.timeline-marker {
  position: absolute;
  left: -32px; /* Positions the marker relative to the timeline-item's new margin-left */
  width: 24px;
  height: 24px;
...
@media (max-width: 768px) {
  ...
  .timeline-marker {
    left: -22px; /* Adjusted to align with line given new timeline-item margin-left */
  }
}
</style>